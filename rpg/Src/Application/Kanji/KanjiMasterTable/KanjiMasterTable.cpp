...
{
	{KanjiID::Hi,	KanjiAttribute::Fire,	100,	"Model_Hi",		"Tex_Hi"},		//火
	{KanjiID::Mizu,	KanjiAttribute::Water,	100,	"Model_Mizu",	"Tex_Mizu"},	//水
	{KanjiID::Wood,	KanjiAttribute::Wood,	100,	"Model_Ki",		"Tex_Ki"},		//木
	{KanjiID::Tsuki,KanjiAttribute::None,	100,	"Model_Tsuki",	"Tex_Tsuki"},	//月
};
